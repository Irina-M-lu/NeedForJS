...
const score = document.querySelector('.score'),
  ...
  //audio.src = 'audio.mp3';
//audio.style.cssText = 'position: absolute; top: -0';
...
const result = parseInt(localStorage.getItem('nfjs.score', setting.score));
...
const addLocalStorage = () => {
  ...
  localStorage.setItem('nfjs.score', setting.score);
